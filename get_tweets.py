...
def get_tweets(jtakoutsing):
	...
	#get tweets
	tweets_for_csv = []
	for tweet in tweepy.Cursor(api.user_timeline, screen_name = jtakoutsing).items(number_of_tweets):
        #create array of tweet information: jtakoutsing, tweet id, date/time, text
		tweets_for_csv.append([jtakoutsing, tweet.id_str, tweet.created_at, tweet.text.encode("utf-8")])

	#write to a new csv file from the array of tweets
	outfile = jtakoutsing + "jtakoutsing_tweets.csv"
